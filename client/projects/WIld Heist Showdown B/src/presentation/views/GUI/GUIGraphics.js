...
export function extractHighResolutionSymbols(assets) {
    ...
    const descriptors = [
		{name: 'symbol1', image: createSymbolIcon(new Base2DSymbolView(1, assets))},
        {name: 'symbol2', image: createSymbolIcon(new Base2DSymbolView(2, assets))},
        {name: 'symbol3', image: createSymbolIcon(new Base2DSymbolView(3, assets))},
        {name: 'symbol4', image: createSymbolIcon(new Base2DSymbolView(4, assets))},
        {name: 'symbol5', image: createSymbolIcon(new Base2DSymbolView(5, assets))},
        {name: 'symbol6', image: createSymbolIcon(new Base2DSymbolView(6, assets))},
        {name: 'symbol7', image: createSymbolIcon(new Base2DSymbolView(7, assets))},
        {name: 'symbol8', image: createSymbolIcon(new Base2DSymbolView(8, assets))},
        {name: 'symbol9', image: createSymbolIcon(new Base2DSymbolView(9, assets))},
        {name: 'symbol10', image: createSymbolIcon(new Base2DSymbolView(10, assets))},
    ].forEach(({
        image,
    }, i) => {
		x++ 
