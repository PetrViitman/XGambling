...
export const REGULAR_SYMBOLS_IDS = [
	2, // RED
	3, // PINK
	4, // GREEN
	5, // YELLOW
...
export const SYMBOLS_IDS = [WILD_SYMBOL_ID, ...REGULAR_SYMBOLS_IDS]

export const REELS_SYMBOLS_IDS = [
	REGULAR_SYMBOLS_IDS,
	SYMBOLS_IDS,
	SYMBOLS_IDS,
	SYMBOLS_IDS,
...
export class SlotMachine {
	...
	getCascadeSteps({
		...
		do {
			...
			step.reelsPatch = this.cascadeReels(reels, corruptionMap)
	...
	generateSingleGameDescriptor({
		...
		const reels = desiredReels ?? this.roll(desiredReels)
		const steps = this.getCascadeSteps({
			reels,
			bet,
		})
